...
setPropertyScope("writeMachine", "post");
setPropertyScope("writeTools", "post");
setPropertyScope("writeVersion", "post");
setPropertyScope("preloadTool", "post");
setPropertyScope("showSequenceNumbers", ["machine", "post"]);
setPropertyScope("sequenceNumberStart", ["machine", "post"]);
setPropertyScope("sequenceNumberIncrement", ["machine", "post"]);
setPropertyScope("optionalStop", "post");
setPropertyScope("separateWordsWithSpace", ["machine", "post"]);
setPropertyScope("useRadius", ["machine", "post"]);
setPropertyScope("useParametricFeed", "post");
setPropertyScope("showNotes", ["machine", "post"]);
setPropertyScope("useG0", ["machine", "post"]);
setPropertyScope("useSubroutines", "post");
setPropertyScope("useSmoothing", "operation");
setPropertyScope("optionallyCycleToolsAtStart", "post");
setPropertyScope("measureTools", "post");
setPropertyScope("toolBreakageTolerance", "post");
setPropertyScope("safeStartAllOperations", "post");
setPropertyScope("fastToolChange", "post");
setPropertyScope("useG95forTapping", ["machine", "post"]);
setPropertyScope("useMultiAxisFeatures", ["machine", "post"]);
setPropertyScope("forceHomeOnIndexing", ["machine", "post"]);
setPropertyScope("singleResultsFile", "post");
setPropertyScope("useClampCodes", "post");
setPropertyScope("coolantPressure", ["operation", "post"]);
setPropertyScope("machineModel", "post");
setPropertyScope("hasAAxis", "post");
setPropertyScope("hasBAxis", "post");
setPropertyScope("hasCAxis", "post");
setPropertyScope("useDPMFeeds", ["machine", "post"]);
setPropertyScope("useTCP", "post");
setPropertyScope("gotChipConveyor", "post");
setPropertyScope("safePositionMethod", ["machine", "post"]);
setPropertyScope("homePositionCenter", ["machine", "post"]);
setPropertyScope("toolArmDrive", "post");
setPropertyScope("useSSV", "post");
setPropertyScope("safeRetractDistance", ["machine", "post"]);
setPropertyScope("useM130PartImages", ["machine", "post"]);
setPropertyScope("useM130ToolImages", ["machine", "post"]);

function setPropertyScope(property, value) {
  if (typeof properties[property] != "undefined") {
    properties[property].scope = value;
  } else {
    error("Cannot set scope for property '" + property + "'. The property does not exist.");
  }
}
